...
function miki({}: Props) {
  return (
    ...
    <div  className="leading-normal tracking-normal text-indigo-400 m-6 bg-cover bg-fixed" style={{ backgroundImage: "url('header.png')" }}>
       ...
       <div className="w-full md:w-3/5 lg:md:3/5 container mx-auto">
    ...
    <div className="container pt-5 md:pt-10 mx-auto flex flex-wrap flex-row items-center w-full md:w-3/5 lg:w-3/5">
        ...
        <p className="leading-normal text-base md:text-2xl mb-8 text-center md:text-left">
          Sub-hero message, not too long and not too short. Make it just right!
        </p>  <div className="container pt-5 md:pt-10 mx-auto flex flex-wrap flex-row items-center w-full md:w-3/5 lg:w-3/5">
        <h1 className="my-4 text-3xl md:text-5xl text-white opacity-75 font-bold leading-tight text-center md:text-left">
          Texlar Mtaani
          <span className="bg-clip-text text-transparent bg-gradient-to-r from-yellow-400 via-pink-500 to-purple-500">
            via pinks
